...
<main class="flex flex-row justify-between">
    <div class="min-w-[65%] mr-auto ml-5">
     ...
     <div class="flex h-20 my-3 min-w-full bg-gray-100 shadow-md">
        ...
        <div class="w-[40%] h-full flex ml-auto justify-between">
            <div class="w-[35%] flex justify-between ml-24">
                <button class="ml-2 w-8 h-8 text-3xl bg-yellow-500 text-white font-bold my-auto"><svg class="w-[80%] h-[80%] mx-auto my-auto" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M10 1H6V6L1 6V10H6V15H10V10H15V6L10 6V1Z" fill="#ffffff"></path> </g></svg> </button>
                <button class="mr-2 w-8 h-8 text-3xl bg-yellow-500 text-white font-bold my-auto"><svg class="w-[80%] h-[80%] mx-auto my-auto" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M1 10L1 6L15 6V10L1 10Z" fill="#ffffff"></path> </g></svg></button>
            </div>
            
             <button class="rounded-md ml-auto mr-4 bg-yellow-500 text-white font-bold w-20 h-10 my-auto">Remove</button>
        </div>
 ...
 @endforeach
    ...
    <div class="min-w-[30%] ml-auto flex mt-10"  >
        <div class="w-[95%] mx-auto bg-gray-100 rounded-md flex flex-col">
